    ...
    <table style="height: 100%; min-height: 400px">
        ...
        <tr>
            <td rowspan="4">
				...
				$shipping_method = ZASH_Order::get_shipping_method( $order, true );
                ...
                <div <?php echo wooi_show_item( $shipping_method ); ?>>
                    <table style="height: 55mm; width: 100%; margin: 0 auto; font-size: 10px;">
                        <tr style="height: 18mm;text-align: center;">
                            <td colspan="2">
                                <img src="<?php echo plugin_dir_url( ZASH_FILE ); ?>assets/images/logo.png" alt=""
                        ...
                        <tr style="height: 4mm;">
                            ...
                            <td>وزن ◀ <?php echo number_format( intval( ZASH_Order::get_order_weight( $order ) ) ); ?>
                                گرم
                            </td>
                        </tr>
                        <tr style="height: 4mm;">
                            <td>تاریخ ◀ <?php echo date_i18n( 'Y-m-d', $order->get_meta( 'zagma_send_time' ) ); ?></td>
                            <td>زمان ◀ <?php echo date_i18n( 'H:i:s', $order->get_meta( 'zagma_send_time' ) ); ?></td>
                        </tr>
                        <tr style="height: 8mm;">
            ...
            <td>
                <div style="text-align: center;">
                    ...
                    <span <?php echo wooi_show_item( $shipping_method ); ?>>
                        <img src="<?php echo plugin_dir_url( ZASH_FILE ); ?>assets/images/zagma.jpg"
